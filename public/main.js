...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (model) {
        ...
        return this.http.post(this.authUrl, model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (obj) {
    ...
    AuthService.prototype.newPassword = function (model) {
        //return this.http.post(this.authUrl, model);
        return this.http.post(this.authUrl, model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (obj) {
            //console.log('auth.service.ts ----- to aqui no login', obj);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('newPassword')));
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(serv, router, message) {
        this.serv = serv;
        this.router = router;
        this.message = message;
        this.loginModel = {};
    ...
    LoginComponent.prototype.askForNewPassword = function () {
        var _this = this;
        // validação
        this.serv.newPassword(this.loginModel).subscribe(function (obj) {
            //console.log('login.componente.ts ----- e ai... aconteceu algo?', obj);
            if (obj && obj.action && obj.action == 'new password') {
                //console.log('login.componente.ts ----- logado... indo para /home!', obj.action);
                _this.message.info(obj.message, true);
                _this.changeView();
            }
        });
    };
